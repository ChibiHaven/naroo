  ...
  return (
    <div className="flex min-h-full flex-col">
      ...
      <main className="flex flex-1 flex-col gap-4 px-5 py-5">
        <div className="inline-flex w-fit items-center rounded-full bg-amber-50 px-3 py-1 text-xs font-semibold text-amber-900">
          {translate('demonstration_mode')}
        </div>

        <section className="rounded-3xl border border-brand-border bg-gradient-to-b from-sky-50 to-white p-5">
